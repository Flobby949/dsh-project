package com.nh.dsh.client.common.cache;
...
import static com.nh.dsh.client.common.cache.RedisCache.HOUR_TWO_EXPIRE;
...
public class TokenStoreCache {
    ...
    public void saveUser(String accessToken, UserLoginVO user) {
        ...
        redisCache.set(userIdKey, accessToken, HOUR_TWO_EXPIRE);
        redisCache.set(accessTokenKey, user, HOUR_TWO_EXPIRE);
    }
